    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Edit(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                _db.SaveChanges();
                TempData[SD.Success] = "Usuario añadido exitosamente";
        ...
        public IActionResult LockUnlock(string userId)
        {
            ...
            if (objFromDb.LockoutEnd != null && objFromDb.LockoutEnd > DateTime.Now)
            {
                ...
                TempData[SD.Success] = "Usuario desbloqueado exitosamente";
            }
            else
            {
                //user is not locked, and we want to lock the user
                objFromDb.LockoutEnd = DateTime.Now.AddYears(1000);
                TempData[SD.Success] = "Usuario bloqueado exitosamente";
            }
            _db.SaveChanges();
            return RedirectToAction(nameof(Index));
        ...
        public IActionResult Delete(string userId)
        {
            ...
            _db.SaveChanges();
            TempData[SD.Success] = "Usuario eliminado exitosamente";
            return RedirectToAction(nameof(Index));
        }
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel userClaimsViewModel)
        {
            ...
            if (!result.Succeeded)
            {
                TempData[SD.Error] = "Error al quitar los permisos";
            ...
            if (!result.Succeeded)
            {
                TempData[SD.Error] = "Error al añadir los permisos";
                return View(userClaimsViewModel);
            }

            TempData[SD.Success] = "Permisos actualizados exitosamente";
            return RedirectToAction(nameof(Index));
        }
    }
}
